...
y = 375
radius = 12
vel = 0.2  # Slow movement speed

# Bullet settings
bullet_vel = 0.5  # Slow bullet speed
...
enemy_vel_x = 0.04  # Horizontal velocity of enemy
enemy_vel_y = 0.04  # Vertical velocity of enemy
enemy_bullet_vel = 0.3  # Enemy bullet speed
